...
namespace PhaseCalculator
{
    ...
    {
        ActiveChannelInfo(const ChannelInfo* cInfo, Settings* s);
    ...
    public:
        ...
        */
        ...
        /* Loads custom Hilbert transformer coefficients from a JSON file,
           overriding the default Matlab-designed FIR coefficients per band.
           Bands not present in the JSON retain their current coefficients.
        */
        ...
        double getScaleFactor(Band band, double lowCut, double highCut);
        ...
        Array<double> localTransformer[NUM_BANDS];
        int localDelay[NUM_BANDS];
    ...
    private:
        ...
        */
        ...
        static double htFilterSamp(double input, Band band, Array<double>& state, const Array<double>* transformer, const int* delay);
